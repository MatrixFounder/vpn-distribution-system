...
§4.5); LOGIC-задачи (отзыв доступа, публикация состава, уведомления — ``send_email`` в 001.52,
агрегация, сверки — §5.4) добавляют свои обработчики сюда. Задачи типов, которых здесь нет,
...
HANDLERS: dict[str, Handler] = {"noop": noop, "ensure_partitions": ensure_partitions}
