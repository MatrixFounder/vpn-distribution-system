...
Состояние на 2026-09-10: принято 19 задач из 86 (63 ч из 291 ч), в работе 0, готовы к началу 9. Блок
...
| Этап 4 — парк нод и Node API | 11 | 38 | 1 | 3 | 0 | 25, 26, 28 |
...
| **Итого** | 86 | 291 | 19 | 63 | 0 | 19, 21, 25, 26, 28, 41, 46, 51, 62 |
...
- **001.26** — Inbound и генератор конфигурации Xray: модель, ключи REALITY, заглушки (заглушки,
  Critical, 3 ч)
- **001.28** — Node API: состояние (long-poll), подтверждение, heartbeat, команды — заглушки
  (заглушки, Critical, 3 ч) — на критическом пути
...
Критический путь до задачи 001.73 — 62 ч по оценкам, 8 из 18 задач приняты: 01 → 02 → 03 → 04 → 09 →
...
gantt
  ...
  section Этап 4 — парк нод и Node API
    ...
    28 Node API — заглушки :active, crit, t28, after t24 t11, 3ms
