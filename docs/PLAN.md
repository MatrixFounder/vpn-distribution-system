...
Состояние на 2026-09-14: принято 20 задач из 86 (66 ч из 291 ч), в работе 1, готовы к началу 9. Блок
...
| Этап 5 — учёт трафика и лимиты | 10 | 32 | 0 | 0 | 1 | — |
...
| **Итого** | 86 | 291 | 20 | 66 | 1 | 19, 21, 25, 26, 41, 46, 51, 53, 62 |
...
gantt
  ...
  section Этап 5 — учёт трафика и лимиты
    33 Отчёты, учёт — заглушки · в работе :active, crit, t33, after t28 t08, 4ms
